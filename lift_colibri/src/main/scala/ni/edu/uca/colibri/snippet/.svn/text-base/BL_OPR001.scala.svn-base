 ...
 */ 
    def transaction():NodeSeq ={
		<table>
		  <tr>
		      <td><OPR001:Next><button>Next</button></OPR001:Next></td>
		      <td><OPR001:Exit><button>Exit</button></OPR001:Exit></td>
		  </tr>
		</table>
    }
   ...
   */ 
     ...
     <lift:BL_OPR001.execute form="post" multipart="true">	
	       {table}  
	       {transaction}
     </lift:BL_OPR001.execute>
	 }
